...
var mime = __webpack_require__(90)
...
var callSiteToString = __webpack_require__(14).callSiteToString
var eventListenerCount = __webpack_require__(14).eventListenerCount
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_nuxt__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_nuxt___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_nuxt__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api__ = __webpack_require__(101);
...
var codes = __webpack_require__(34)
...
var callSiteToString = __webpack_require__(19).callSiteToString
var eventListenerCount = __webpack_require__(19).eventListenerCount
var relative = __webpack_require__(1).relative
...
var bomHandling = __webpack_require__(50),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(51); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(65)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(66)(iconv);
}
...
module.exports = {
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(61) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(12).concat(__webpack_require__(21)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(12).concat(__webpack_require__(21)) },
        gb18030: function() { return __webpack_require__(62) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(22).concat(__webpack_require__(64)) },
...
var bomHandling = __webpack_require__(69),
    iconv = module.exports;
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(70); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(24).concat(__webpack_require__(83)) },
        encodeSkipVals: [0xa2cc],
    },
...
var first = __webpack_require__(87)
...
router.get("/items", function (req, res, next) {
  // JSON.parse => sync
  const obj = JSON.parse(__WEBPACK_IMPORTED_MODULE_2_fs___default.a.readFileSync(process.cwd() + "/assets/items.json"));
  res.json(obj.items);
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config__ = __webpack_require__(106);
...
let filepath = process.cwd() + "/" + __WEBPACK_IMPORTED_MODULE_4__config__["a" /* rootPath */] + "/";
...
router.post("/upload", upload.single("imageURL"), (req, res, next) => {
  ...
  if (body.type === "json") {
    ...
    const obj = JSON.parse(__WEBPACK_IMPORTED_MODULE_3_fs___default.a.readFileSync(fullpath));

    let update = {
      imageURL: __WEBPACK_IMPORTED_MODULE_4__config__["b" /* staticPath */] + req.file.filename
    };
    ...
    __WEBPACK_IMPORTED_MODULE_3_fs___default.a.writeFile(fullpath, JSON.stringify(obj), "utf8", () => {
      res.sendStatus(201);
    });
  } else {
    // image file
    ...
    __WEBPACK_IMPORTED_MODULE_3_fs___default.a.rename(after, before, () => {
      res.sendStatus(201);
    });
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_fs__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_fs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_fs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config__ = __webpack_require__(106);
...
const router = Object(__WEBPACK_IMPORTED_MODULE_0_express__["Router"])();
let target = __WEBPACK_IMPORTED_MODULE_3__config__["a" /* rootPath */];
...
const staticPath = "http://localhost:3000/images/";
/* harmony export (immutable) */ __webpack_exports__["b"] = staticPath;
